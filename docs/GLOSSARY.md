# Alpha Radar Glossary

This glossary defines preferred English and Simplified Chinese terminology for Alpha Radar UI,
documentation, and future AI output. Canonical financial identifiers such as tickers, slugs,
provider IDs, ETF, BTC, ETH, TVL, OI, and RWA should generally remain unchanged.
...
| Fundamentals | 基本面 |  |
| Capital Flow | 资金流 |  |
| Narrative | 市场叙事 | Avoid literal translations that lose market context. |
| Risk | 风险 |  |
| Opportunity | 机会 |  |
| Impact | 影响强度 | Use for scored market/asset effect. |
| Confidence | 置信度 |  |
| Priced-in | 已计价程度 |  |
| Watchlist | 自选 |  |
| Portfolio | 投资组合 |  |
